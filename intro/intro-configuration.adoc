...
[TIP]
=====
The table density of newer interfaces can be xref:_table_density[adjusted in Workstation Administration].
=====
...
* xref:_column_selections[Column Selections]
...
* xref:_prevent_links_from_opening_in_new_tabs[prevent links from opening in new tabs]
* xref:_include_full_library_names_in_library_selector[set the library selector to include the full name of libraries]
* xref:_table_density[adjust table density]
