...
Hatch is an *optional* installable program that works with your browser to manage complex printing needs, 
such as printing to different printers under different circumstances.
...
Refer to xref:_hatch_printing[] to configure printer settings.

Refer to xref:_hatch_troubleshooting[] if you are having issues with Hatch.
