...
** If you use Hatch to store settings, after the upgrade you will need to move your settings from Hatch to the server. See xref:convert-hatch-settings-to-local-storage []
