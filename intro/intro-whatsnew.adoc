...
+
* Though the new web client looks and functions similar to the old staff client, you will experience differences when navigating on it. Please refer to xref:_getting_startrd[] and xref:configure-browser[] for details.
+
...
* Ehnancement on merging bibliographic records in Record Bucket and overlaying records via Z35.50. Merge profile may be applied.
+
