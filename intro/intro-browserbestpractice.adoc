...
. Under _General Settings_ make sure  _Block third-party cookies_ is selected.
...
. Click the toggle at the top right of the screen that says _Developer Mode_.
. Scroll down to Hatch Native Messenger.
. Click on the link that says *service worker*. (This will open a new window.)
...
. Click *More* and select _All time_ to set the time range.
