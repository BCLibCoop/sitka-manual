...
xref:_deleting_records_via_a_record_bucket[deleting], and xref:_exporting_marc_records_via_a_record_bucket[exporting] the records.

Buckets can be shared with Co-op Support for batch editing assistance and troubleshooting. Buckets can also be used for matching
when importing records via the Batch Import function.
