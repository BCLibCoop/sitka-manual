...
*Create a Record Bucket on Record Buckets* view
...
*Create a Record Bucket when Adding a Record to a Bucket*
...
You are prompted to add the record to an exsting bucket or a new bucket for the record. To add to a new bucket, type in a name in *Name For New Bucket* box, then click *Add to New Bucket*.

image::images/cat/record-bucket-6.png[]

[[add-record-to-bucket]]
Add Records to a Record Bucket
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
*Add Imported Records on MARC Batch Import/Export*
...
Work with Records in a Record Bucket
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
