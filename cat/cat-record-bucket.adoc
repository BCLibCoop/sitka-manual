...
in xref:_searching_the_database_for_cataloguing_purposes[].
. Select the titles you would like to add the basket.
+
...
** This action will move the slected records to the *Pending Records* tab so they can be added to a different 
record bucket. 
...
** See xref:_export_marc_records_via_a_record_bucket[].
