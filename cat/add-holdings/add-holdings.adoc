...
[TIP]
=====
* Evergreen allows one library to have one unique call number under one title. When saving new copies or editing existing copies, copies sharing the same call number are grouped under one volume record.
