...
+
. You may configure the default displayed fields in volume-copy editor. Click on *Default* on volume-copy editor. See xref:_volume-copy_defaults[] for more information.
+
