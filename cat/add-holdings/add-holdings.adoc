...
Sometimes you may need to create a volume/call number record without any copy. For exampple, you may want to move one of two regular collection copies to reference, which will use a different call number prefix or catalouge a pre-catalogued item. 
