...
+
* You can configure the default displayed fields in Volume/Copy Editor. Click on *Defaults* on Volume/Copy Editor. See xref:_volume_copy_defaults[] for more information.
+
