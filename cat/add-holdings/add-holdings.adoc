...
.. To ensure data consistency, we recommend using holding templates. Select one from the drop down list,
then click on *Apply Template*. Refer to xref:_holdings_templates[] for more information on creating
holding templates.
+
