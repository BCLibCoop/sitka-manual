...
When there is no matching MARC record for your item, you may import one from the Z39.50 
sources or the files supplied by your vendors. Or you may create a new MARC 
record if you can not find one from other sources.
