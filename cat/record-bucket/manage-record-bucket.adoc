...
To view record buckets, go to *Cataloging -> Record Buckets*.
...
recommended that staff go to *Cataloging -> Search Catalog* as there are more options available 
...
* xref:_record_bucket_action_add_favorite[Add to Favorites]
* xref:_record_bucket_action_carousel[Create Carousel from Bucket]
...
* xref:_record_bucket_action_remove_favorite[Remove from Favorites]
* xref:_record_bucket_action_share[Share Bucket]
* xref:_record_bucket_action_transfer_owner[Transfer Bucket Ownership]
* xref:_record_bucket_action_upload[Upload Records]

Add to Favorites
++++++++++++++++
[[_record_bucket_action_add_favorite]]

This adds a record bucket to your Favorites. 
Favorited buckets will populate  your Favorites view in the buckets interface, as well as in the staff catalogue buckets tab. 

This action can also be taken by clicking the star icon. Clicking the star icon so that it turns yellow adds a bucket to your Favorites list.

Create Carousel From Bucket
+++++++++++++++++++++++++++
...
This action can also be taken by clicking on the X icon in the record bucket grid.

Edit Bucket
++++++++++++
[[_record_bucket_action_edit]]

This allows you to edit the bucket details, including name, description, and whether or not 
the bucket is public.

This action can also be taken by clicking on the pencil icon in the record bucket grid.
...
permissions will prevent any batch edits. Please https://bc.libraries.coop/support/[contact Co-op Support] for assistance 
with batch editing.

Remove from Favorites
+++++++++++++++++++++
[[_record_bucket_action_remove_favorite]]

This removes a record bucket from your Favorites. 
...
This action can also be taken by clicking the star icon. Clicking the star icon so that it changes from yellow (to transparent) removes a bucket from your Favorites list.
...
This action can also be taken by clicking on the person icon in the record bucket grid.
