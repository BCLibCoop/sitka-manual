...
This adds or removes a record bucket to or from your Favourites. 
...
This action can also be taken by clicking the star icon. Clicking the icon so that it turns yellow adds a bucket to your Favorites list, and clicking the star again removes it.
