...
This action can also be taken by clicking the star icon. Clicking the icon so that it turns yellow adds a bucket to your Favorites list.
...
This action can also be taken by clicking the star icon. Clicking the icon so that it changes from yellow (to transparent) removes a bucket from your Favorites list.
