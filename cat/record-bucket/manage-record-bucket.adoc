...
To view record buckets, go to *Cataloguing -> Record Buckets*.
...
* xref:_record_bucket_action_add_favourite[Add to Favorites]
...
* xref:_record_bucket_action_remove_favourite[Remove from Favourites]
...
Add to Favorites
++++++++++++++++
[[_record_bucket_action_add_favourite]]

This adds a record bucket to your Favourites. 
...
+++++++++++++++++++++
[[_record_bucket_action_remove_favourite]]

This removes a record bucket from your Favourites. 
