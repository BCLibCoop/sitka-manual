...
* xref:_record_bucket_search_results_single_record[Individual records via Search Results]
* xref:_record_bucket_search_results_multiple_records[Multiple records via Search Results]
* xref:_record_bucket_staff_catalogue_basket[Multiple records via the Staff Catalogue Basket]
* xref:_record_bucket_record_summary[Individual records via Record Summary]

[[_record_bucket_search_results_single_record]]
Individual records via Search Results
+++++++++++++++++++++++++++++++++++++
...
. Click *Add to Bucket* on the result. Clicking on the arrow beside will show a drop down menu of existing buckets.
+
image::images/cat/buckets/record-bucket-add-search-result-1.png[]
+
. With the pop-up that appears, records can be added to:
** an existing bucket.
+
...
[[_record_bucket_search_results_multiple_records]]
A single record via Search Results
++++++++++++++++++++++++++++++++++
...
Multiple records via the Staff Catalogue Basket
+++++++++++++++++++++++++++++++++++++++++++++++
...
Individual records via Record Summary
+++++++++++++++++++++++++++++++++++++
...
+
. Continue searching and adding records to your bucket or click on *Bucket View* to go to your bucket.
