...
[NOTE]
======
You can also add the contents of a basket directly to a favourite or recent bucket on _Bucket_ tab, to 
the left of the search results. Hover over the bottom right hand corner of bucket description and _Add X_
will appear. Click to add the records from your basket to the bucket.

image::images/cat/buckets/record-bucket-tab-add-1.png[]
======
