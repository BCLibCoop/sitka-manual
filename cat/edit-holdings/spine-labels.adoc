...
.. Page Settings section allows you to specify the position of the labels: the page margin, number of rows and columns of labels on each page and gaps between labels.
