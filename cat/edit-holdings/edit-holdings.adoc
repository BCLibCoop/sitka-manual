...
In Evergreen, the call number is kept in a separate record, called call number record. Items under the same title with the same call number share the same call number record. Item records and call number records can be edited at several places.
