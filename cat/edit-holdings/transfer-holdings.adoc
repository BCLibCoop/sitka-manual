...
[NOTE]
======
You can xref:_working_with_items_in_a_bucket[use an item bucket] to transfer a number of items at once. To do so, select the items you would like to move to another bucket, and then from the *Actions* menu select *Transfer Selected Items to Marked Call Number*.
======
