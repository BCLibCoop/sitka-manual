...
After the destination or target record has been marked for Holding Transfer, navigate to the desired item bucket. Then, select the items in the bucket that you would like to transfer, and from the *Actions* menu select *Transfer Selected Items to Marked Call Number*.
======
