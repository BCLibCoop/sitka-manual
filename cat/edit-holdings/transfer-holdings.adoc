...
Co-op Support recommends you read through the process first before starting, as each scenario has
...
+
. Go to *Holdings View* of the source title.
. Select the call number you want to transfer. Click *Actions* list.
+
