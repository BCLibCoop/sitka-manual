...
link:https://youtu.be/-yNomv-jIWU[*Sitka Training Video - Holdings Editor (13:58)*]
...
link:https://youtu.be/yJIFFWY8e74[*Sitka Snippet Video - Holdings Details (2:38)*]
...
link:https://youtu.be/DVLUXIVLXdM[*Sitka Snippet Video - Item Attributes (6:02)*]

The Item Attributes section contains information specific to your library's items.  You can customize which
attributes display in the xref:_working_item_defaults[defaults for the Working Item Tab].
