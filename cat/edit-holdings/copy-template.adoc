...
. You can create a holdings template directly under *Admin -> Local Administration -> Holdings Template Editor* or  you can create a holdings template when creating a new item or editing an existing item record.
+
