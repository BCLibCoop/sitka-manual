...
+
. You can also replace an item's barcode on *Item Status* screen. Select the item, click *Actions* dropdown list. Scroll down to *Edit*, then choose *Replace Barcode*.
+
