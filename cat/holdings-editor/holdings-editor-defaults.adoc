...
image::images/cat/holdings/holdings-editor-preferences-2.png[]
...
Set a default Item Alert Type to be used when adding item alerts in _Default Item Alert Type_. 
