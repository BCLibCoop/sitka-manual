...
[NOTE]
======
The Holdings Editor can display the Holdings Details and Item Attributes as separate tabs or be can unified the
two into a single tab as shown above.  This is done via the setting _Unified Holdings and Item Attributes Display_ on the 
