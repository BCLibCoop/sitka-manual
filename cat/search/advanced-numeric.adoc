...
+
. Confirm bibliographic data as displayed in the brief record. If satisfied that the record matches the item in hand, you can proceed to add holdings as described in <<add-holdings.adoc#cat-add-holdings-add-holdings, Adding Holdings to Title Records>>.
+
