...
+
image::images/catnew/viewing-search-results-1.png[section of the search result with the title link circled]
+
...
+
image::images/catnew/viewing-search-results-2.png[Record Details with MARC View]
+
