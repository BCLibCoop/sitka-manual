...
| $9 | Required; your library code | BBI | 	Not displayed in the OPAC but required for the record to be included in searches scoped to your library
|===
. After the tag 856 is added, the record will be displayed as search result on OPAC for the library 
in $9. The image below shows a sample 856 tag and the corresponding public catalogue display. 
+
