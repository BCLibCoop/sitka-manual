...
. Click *Save*.
. The record is created and will open up in your tab in the current default view. If you did not utilize *Fast Item Add*, you may now attach holdings as described in xref:_add_holdings[]
