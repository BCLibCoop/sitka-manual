...
Copies can be added to a bucket when they are displayed on *Checkin*, *Item Status* and *Holdings View*. You can select multiple items and add them to a copy bucket at one time. 
