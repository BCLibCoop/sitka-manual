...
link:https://youtu.be/DmLBBMAMFDQ[Sitka Snippet Video - Copy Buckets (4:33)]
...
. You can select multiple items and add them to a copy bucket at one time.    . Click *Actions -> Add Items to Bucket*.
+
