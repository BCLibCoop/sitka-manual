...
You can also create a bucket from within a copy record. When a copy is displayed a screen such as, *Checkin*, *Checkout*, or *Items Out*, you can add it to a copy bucket by choosing *Actions -> Add Items to Bucket*. 
