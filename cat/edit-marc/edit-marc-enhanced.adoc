...
* Values can be edited directly in the grid fields.
* Right-clicking in most fields will display a list of the possible values as per MARC21
* Changing the values of certain field, such as Type and BLvl, changes the type of
...
* Right-clicking in the MARC tag field will provide options for adding and 
removing fields.
+
image::images/cat/marc-edit-enhanced-4.png[]
+
* Right-clicking in the MARC tag field will list potential fields that can be added.
