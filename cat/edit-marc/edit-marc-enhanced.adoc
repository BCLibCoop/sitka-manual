...
Evergreen.
* When the *Special Characters* button is clicked, a pop-up appears for the _Special Characters
Map_. Character sets for Latin, Punctuation, and Canadian syllabics are available. Clicking on
a character will copy it and it can then be pasted into the MARC record in the desired spot.
+
image::images/cat/marc/special-characters-map-1.png[]
+  
...
+
image::images/cat/marc/help-additional-options-2.png[]
...
. In the Enhanced MARC Editor, click the icon to the right of the 007 field. See 
...
+
image::images/cat/marc/physical-characteristics-wizard-2.png[]
+
...
+
image::images/cat/marc/physical-characteristics-wizard-3.png[]
+
