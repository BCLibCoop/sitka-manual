...
To export MARC records from Record Bucket, go to Cataloguing -> Record Bucket. Retrieve the bucket containing the records that you wish to export. Click Export All Records to select the exported record format. You will be prompted to save the file.
