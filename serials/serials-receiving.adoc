...
Issues can be received through the _Manage Issues_ tab or through the *Quick Receive* option located in 
the xref:_bibliographic_record_display[bibliographic record display].

Quick Receive
~~~~~~~~~~~~~

. From a serials record in the staff catalogue, go to *Serials* -> *Quick Receive*.
+
image::images/serials/quick-receive-1.png[scaledwidth="75%"]
+
. Confirm the desired library and subscription is selected and click *Continue*.
+
image::images/serials/quick-receive-2.png[scaledwidth="75%"]
+
...
+
image::images/serials/quick-receive-3.png[scaledwidth="75%"]
+
. Click *Receive* to receive the issue. The Status of the issue will update to "Received" and a Date Received will be recorded.
...
+
image::images/serials/quick-receive-5.png[scaledwidth="75%"]
...
. Uncheck the box adjacent to *Barcode Items* and click *Receive*.
+
image::images/serials/quick-receive-4.png[scaledwidth="75%"]
+
. The Holdings Summary in the _Issues Held_ tab in the catalogue will reflect the newly received issue.
+
image::images/serials/quick-receive-5.png[scaledwidth="75%"]
