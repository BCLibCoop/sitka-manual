...
+
image::images/serials/create-subscription-1.png[scaledwidth="75%"]
+
...
.. *Receiving Template* - Specifies the item attributes applied on receipt - see xref:_serial_item_templates[] for more information.
...
. Click *Save*
+
image:images/serials/create-subscription-2.png[scaledwidth="75%"]
+ 
. The new subscription will appear in the grid at the bottom of the page.
+
image:images/serials/create-subscription-3.png[scaledwidth="75%"]

Create and Manage Predictions
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

From the _Manage Predictions_ tab you can create a new prediction pattern from scratch, use an existing pattern 
template, or use an existing pattern template as the basis for a new prediction pattern.
...
+
. Follow the xref:_pattern_wizard[] steps to modify the template.
. Click *Create*.
+
...
+
image:images/serials/predict-issues-1.png[scaledwidth="75%"]
+
...
. Click *Save*.
+
image::images/serials/predict-issues-2.png[scaledwidth="75%"]
+
. Evergreen will generate the predictions and bring you to the _Manage Issues_ tab to review the predicted issues.
+
image::images/serials/predict-issues-3.png[scaledwidth="75%"]
...
+
image::images/serials/predictions-template-1.png[scaledwidth="75%"]
+
. If you want to use the pattern "as is" click *Create*.
+
image::images/serials/predictions-template-2.png[scaledwidth="75%"]
+
...
After generating predictions in the _Manage Predictions_ tab, you will see a list of the predicted issues in 
the _Manage Issues_ tab.  

image::images/serials/manage-issues-1.png[]

A variety of actions can be taken in this tab:
