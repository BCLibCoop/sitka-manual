...
Serial item templates specify the item attributes that should be applied when a serial item is received. You must 
create at least one template to receive serials.

Create a Serial Item Template
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

. Go to *Administration* -> *Serials Administration* -> *Serial Item Templates*.
...
+
. Choose the applicable item attributes for your template. For more information on specific item
attributes see xref:_item_attributes[].
+
. Click *Save*.
+
...
[NOTE]
======
Serial Item Templates cannot be deleted.
========
...
. Go to *Administration* -> *Serials Administration* -> *Prediction Pattern Templates*.
+
. Click *New Record*.
+
image::images/serials/prediction1.png[scaledwidth="75%"]
+
. Enter a name for your prediction pattern.
+
...
+
image::images/serials/create-prediction-pattern-2.png[scaledwidth="75%"]
+
.. See xref:_pattern_wizard[] for detailed instructions.
...
image:images/serials/pattern-wizard-1.png[scaledwidth="75%"]
...
image:images/serials/pattern-wizard-2.png[scaledwidth="75%"]
...
image:images/serials/pattern-wizard-3.png[scaledwidth="75%"]
...
. Click *Next*
+
image:images/serials/pattern-wizard-4.png[scaledwidth="75%"]

.*Review*
. Review the *Pattern Summary*
.. Click the blue arrows to see the *Raw Pattern Code*
+
image:images/serials/pattern-wizard-5.png[scaledwidth="75%"]
+
. Click *Save*
+
image:images/serials/pattern-wizard-6.png[scaledwidth="75%"]
