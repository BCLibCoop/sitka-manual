...
modifiers you use and https://bc.libraries.coop/support/[contact Co-op Support] to set up new circulation policies.  If 
reserve materials are not holdable, your applicable shelving locations will need to be set accordingly, or, your hold 
...
** xref:_associating_an_item[Catalogued items] from your collection.
** xref:_associating_an_electronic_resource_from_the_catalogue[Electronic resources] from your collection.
** xref:_associating_an_electronic_resource_using_a_brief_record[Brief records] for electronic resources that are not part of the library's 
collection.
...
. Go to *Administration -> Local Administration -> Course Reserves List*.
. Select the course you wish to delete and from the *Actions* menu choose
*Delete Selected*.
+
