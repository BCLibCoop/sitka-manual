...
* anchor:nullibility_commonly_used_tables[Nullibility]By default, tables are often, but not always, joined by left join. Other join types may be available. Select 
