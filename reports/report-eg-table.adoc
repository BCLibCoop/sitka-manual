...
the _Record In-House Use_ interface.
...
This table contains non-catalogued circulations. When a non-catalogued checkout is recorded, a record is created in this table. 
...
+++++++++++++++++++++++++++++++++
  ...
  This table contains the non-catalogued item in-house use records. Follow the link to Item 
...
++++++++++++++++++
  ...
  When an item is sent in transit, regardless of whether it is going back to its circulating 
...
++++++++++++
 ...
 When an item is sent in transit to fill a hold, a hold transit record is created in this table 
...
++++++++++++
 ...
 When a hold is placed, a hold record is created in this table. You may find the hold receiver's 
...
Billable Transaction with Billing Location
++++++++++++++++++++++++++++++++++++++++++
...
++++++++
 ...
 ALL contains all payment records. When a lump sum of payment is made on the staff client, one 
...
++++++++++++++++++++++++++
 ...
 contains all payments made at the circulation desk.
...
++++++++++++++++++++++++++
 ...
 Forgive/Work/Goods/Patron Credit payments.
