...
recommends checking the Sitka_templates to see if there is a template that can be modified to give
you the information you need.

. In the reporter open the folder you wish to creat the template in.
