...
built out. The top of the left-hand pane of the Display Field and Filter Selector section of the 
Report Template Editor contains the Core Sources drop down menu.
...
+
ref:_removing_a_display_field[Removing a Display Field]
...
For example, if the status is _Missing_ in Evergreen you must use _Missing, a value of _missing_ will 
not return results.
