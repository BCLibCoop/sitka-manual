...
In the report template editor a Venn diagram indicates the type of join used between tables. 

To change the type of join used, click on the icon beside the table name and select the join you wish to use.
