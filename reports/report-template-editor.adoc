...
The top of the left-hand pane of the Field and Filter Selector contains the Core Sources drop down menu.
...
use is a Link you need to expand the tree on the left to find it and then click on it.
+
