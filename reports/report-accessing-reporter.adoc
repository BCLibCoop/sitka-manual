...
Staff with reporter permissions can use the Sitka report templates xref:_staff_assigned_to_supplementary_permission_group_s[_Staff Assigned to Supplementary Permission Group(s)_]
