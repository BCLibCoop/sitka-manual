...
[NOTE]
======
Any report output you wish to access via the email link must be stored in a shared output folder. You will not be able to log in to the report link if the output is not shared.
