...
Recurring reports running directly off of Sitka templates off or using accounts of former staff members should be stopped and new recurring reports set up properly.  
