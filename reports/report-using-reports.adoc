...
If you run a report whose output contains patron PII for un-opted in patrons from outside of your 
library, the xref:_personally_identifiable_information_pii_redaction[PII will be redacted] 
and display as a blank field.
