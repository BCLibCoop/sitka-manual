...
////
Co-op Support has created report templates for commonly needed reports.  These templates are shared with
all of Sitka can be found in the _Templates_ folder in the _Shared Folders_ section in Evergreen's reporter.
