...
[NOTE]
======
The following video demonstrates editing report templates in Evergreen.

link:https://youtu.be/bIchc-nEekg[*Sitka Continuing Training Webinar - More Than Just Cloning: Editing Report Templates (41:29)*]
======
