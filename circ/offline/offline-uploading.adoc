...
NOTE: Besides the above regular steps, you may need to handle exceptions if your some transactions can not be processed.
...
NOTE: Depending on your browser's setting, you may be prompted to choose a location to save file.
