...
include::holds/hold-viewing.adoc[Viewing Holds]

include::holds/hold-managing.adoc[Managing Holds]

include::holds/hold-cancelling.adoc[Cancelling Holds]
...
include::holds/hold-browse-holds-shelf.adoc[Holds Shelf]

include::holds/hold-groups.adoc[Managing Hold Groups]
