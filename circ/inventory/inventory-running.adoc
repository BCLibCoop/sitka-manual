...
. Use copy/paste to break the big list of barcodes into smaller lists and save each list as an
individual text file. Each list contains under 500 barcodes. Name your files in sequence 
so that it will be easy to follow when you upload the files (e.g. inventory001, inventory002, etc.).
. Go to **Circulation -> Item Status**.
