...
Damaged
^^^^^^^
If a patron damages an item it can be marked as damaged at check in, via the Item Status interface, from the Holds Shelf, or
from within a patron's account.

. On the appropriate interface select the item and, and
* at check in, click *Actions -> Mark Items Damaged*
* in the Item Status interface, click *Actions -> Mark -> Item as Damaged*
* from the Holds Shelf, click *Actions -> Mark Item Damaged*
* within a patron account, click *Actions -> Mark Damaged*
+
...
. On the appropriate interface select the item and,
* at check in, click *Actions -> Mark Items Discard/Weed*
* in the Item Status interface, click *Actions -> Mark -> Item as Discard/Weed*
* from the Holds Shelf, click *Actions -> Mark Item Discard/Weed*
+
...
. On the appropriate interface select the item, and
* in the Item Status interface, click *Actions -> Mark -> Item as Missing*
* from the Holds Shelf, click *Actions -> Mark Item Missing*
+
