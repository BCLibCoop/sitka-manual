...
. On the appropriate interface select the item click *Actions -> Mark Items Damaged*, *Actions -> Mark -> Item as Damaged*, *Actions -> Mark Item Damaged*, or *Actions -> Mark Damaged* (depending on interface).
+
