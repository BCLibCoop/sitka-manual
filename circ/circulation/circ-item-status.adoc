...
To access _Item Status_ select  *Cataloguing -> Item Status* or *Circulation -> Item Status*.  By default
...
actions on selected items via the *Actions* menu.

image:images/circ/item-status-1.png[]

The _Detail View_ allows staff to use the different tabs to see a variety of information about a specific item.

image:images/circ/item-status-2.png[]

Clicking on the item's title in either the _List View_ or _Detail View_ will open the record in the 
staff catalogue.
