...
This feature uploads multiple items saved in a text file on your local computer. To ensure smooth uploading and further processing of the items, it is recommended that the list contain no more than 100 items.
