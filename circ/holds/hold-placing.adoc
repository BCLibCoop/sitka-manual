...
+
. Enter the patron's barcode if you have it or click *Search for Patron*. Edit the patron 
notification fields if necessary and click *Place Hold(s)*. 
.. Any method or contact number entered on this screen will override defaults in patron record 
and will be used for display and print purposes for this hold.
+
...
. Search the catalogue to identify the record on which you wish to place a hold
