...
+
. Click *Apply*.
. The hold will now have the queue position of 1.  If a 
...
TIP: If an item has already been assigned to the hold on top of the queue,  you need to suspend 
the old top hold, *Find Another Target* for the new top hold, then activate the old top hold.
