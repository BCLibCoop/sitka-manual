...
items eligible to fill a particular hold every 24 hours.  Library staff can re-target holds which forces
...
. On the _View Holds_ tab in the staff catalogue or on the _Holds_ tab in the patron's account, select 
the hold you wish to re-target and go to *Actions -> Find Another Target*.
