...
may be created once such bills are voided. To close negative bills, you can link:_adjust_bill_balance_to_zero.html[adjust the balance to 
zero], refund the balance amount, or link:_adding_new_grocery_bills.html#_add_charge_to_existing_bill[add a bill entry to the negative line item].
