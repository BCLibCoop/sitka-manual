...
+
. Click on drop down arrow and select *Billing Type*, enter bill amount, and any required note, and click *Submit Bill*.
+
...
+
. Click on drop down arrow and select *Billing Type*, enter bill amount, and any required note, and click *Submit Bill*. The bill's balance is updated.
