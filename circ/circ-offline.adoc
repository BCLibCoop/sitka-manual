...
In order to do offline circulation, you have to make your workstations ready. Some information required by the Offline Circulation program needs to be downloaded to your computers. You need network to access Evergreen server to do it. 
