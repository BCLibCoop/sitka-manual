...
+
. If the patron had _Email_ selected as their default for hold notices you need to uncheck the box in the
patron account or you will be unable to save the account in the future.
. Evergreen will automatically archive the penalty when a new email address is entered.
. To resolve the penalty manually go to the *Messages* tab.
