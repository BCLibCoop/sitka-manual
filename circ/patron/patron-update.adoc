...
be applied that can be seen in the Messages.  Additionally, in the summary the address label will appear
in red.
+
image:images/circ/patronupdate15.png[]


Library setting Invalid patron address penalty set to TRUE
