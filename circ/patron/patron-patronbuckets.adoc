...
.. If creating a new user bucket, a dialog box called _Create Bucket_ will appear where you can enter a bucket _Name_ and _Description_ and indicate whether the bucket is _Shareable_.  Click *Create Bucket*.
...
To delete users refer to xref:_patron_deletion_tool[]
