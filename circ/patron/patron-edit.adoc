...
* xref:_replacing_patron_barcode[Replacing a Patron Barcode]
* xref:_editing_current_patron_barcodes[Editing Current Patron Barcodes]
...
[[_editing_current_patron_barcodes]]
