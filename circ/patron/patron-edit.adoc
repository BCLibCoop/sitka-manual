...
account with a warning that the barcode is inactive and will not allow check outs.
...
[TIP]
======
To batch delete inactive barcodes from multiple patrons, local system administrators can use 
