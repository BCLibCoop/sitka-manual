...
If a patron has multiple physical library cards or patron accounts have been merged together, staff
...
barcode you would like to delete is currently active following the steps for 
