...
your library and for which patrons. Contact xref:https://bc.libraries.coop/support/[Co-op Support] to have 
...
|Within City Limits? | Yes | Unchecked by default, this check box indicates that the address is within the city limits.
