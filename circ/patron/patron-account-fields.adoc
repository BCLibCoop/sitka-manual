...
A True value means the related fields will be visible. When these library settings are not assigned a value, the related fields will also be visible. The applicable library settings are:
