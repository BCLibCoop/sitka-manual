...
The patron account form can display _Required Fields_, _Suggested Fields_, or _All Fields_. 

image:images/circ/patron-fields-1.png[]

By default _All Fields_ is selected.  A local system administrator at your library can set the default to 
...
show at all in the patron account form regardless of whether _Required Fields_, _Suggested Fields_, or _All Fields_ is selected.
=====
