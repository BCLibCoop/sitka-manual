...
. *Holds Notices* default setting is Phone and Email, and *Default Hold Notification Phone Number* and *Email Address* are required fields. You can override these settings and required fields with patron's actual preferences as needed.
