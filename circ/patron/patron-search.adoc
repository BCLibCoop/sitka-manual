...
[NOTE]
======
A message will display if an inactive patron barcode is used to retrieve a patron account and
the patron will not be able to check out items.

image:images/circ/retrieve-patron-2.png[]
======
...
Libraries participating in reciprocal borrowing agreements, like BC OneCard, can opt-in patrons from other
