...
+
. Edit the *Number of days to fetch*. For example, if you would like to see only resources that are needed today, you can enter 1 in the box, and you will retrieve a list of resources that need to be pulled today.
