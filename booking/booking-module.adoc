...
image::images/booking/booking-create-1_web_client.png[]
...
image::images/booking/booking-create-4_web_client.png[]
...
image::images/booking/booking-create-5_web_client.png[]

7) Select the pickup location from the dropdown list.

image::images/booking/booking-create-6_web_client.png[]
...
image::images/booking/booking-create-9_web_client.png[]
...
image::images/booking/booking-create-module-1_web_client.png[]
...
image::images/booking/booking-create-module-3_web_client.png[]
...
image::images/booking/booking-create-module-4_web_client.png[]
...
image::images/booking/booking-pull-1_web_client.png[]
...
image::images/booking/booking-capture-1_web_client.png[]

2) Scan the item barcode or type the barcode then click Capture.

image::images/booking/booking-capture-2_web_client.png[]
...
image::images/booking/booking-pickup-1_web_client.png[]

image::images/booking/booking-pickup-module-1_web_client.png[]
