...
https://youtu.be/4tBmSfdUwt8[*Sitka Snippet Video - Create Reservations* (1:59),window=_blank]
...
+
. The message Capture succeeded will appear to the right. Information about the resource will appear below the message.
. Click *Print* to print a slip for the reservation.
