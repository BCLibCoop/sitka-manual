...
inactive cards and patron accounts while retaining needed statistics. This is done outside of patrons' records, 
and a small batch of barcodes/records can be deleted at once. The table below describes a few scenarios 
