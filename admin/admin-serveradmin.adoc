...
If you wish to use hard due dates please contact https://bc.libraries.coop/support/[Support] 
with the following:

* Date or dates for the hard due date
* Who and what the hard due date should apply to
** Refer to Understanding Your Circulation Policies for the information on the parameters you can specify
* Whether the hard due should applly all the time or just truncate the regular due dates when they would
...
For instance, you may wish to send the dates for your fall, winter, and summer terms to Support every August
so that your dates can be entered for the entire year.
=====
