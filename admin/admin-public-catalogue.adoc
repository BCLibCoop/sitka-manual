...
There are a number of library setting that can be used by local system administrators to customize 
the public catalogue.

xref:localadmin/admin-lse.adoc#_library_settings_editor[]
...
+++++++++++++++++++++++
Banner text can be formatted using 
