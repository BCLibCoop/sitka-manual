...
Messaging on the public catalogue can be customized with a temporary banner with text and links which is applied across the top of your public catalogue, and a custom message displayed on log in.
...
| Italic | `$$<i>hello</i>$$`      
| Underline   | `$$<u>hello</u>$$`   
| Link   | `$$<a href="https://bc.libraries.coop">hello</a>$$`   
| Line Break  | `$$hello<br>hello$$`   
|===
...
image::images/admin/opac-login-message-customize-1.png[]
