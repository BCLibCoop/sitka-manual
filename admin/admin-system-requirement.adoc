...
To limit your public catalogue terminals to catalogue searches local configuration will be required. 

*Barcode Scanners*

Evergreen will work with virtually any barcode scanner.
