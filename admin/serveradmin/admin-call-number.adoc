...
If your library uses prefixes and/or suffixes in call numbers, you can build a standard list which 
...
To edit or delete a label, check the checkbox of the specific prefix/suffix and then click *Edit Selected* or *Delete Selected*.
