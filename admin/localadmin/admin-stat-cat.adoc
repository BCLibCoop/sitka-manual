...
Item statistical categories can xref:_sitka_templates_collection[be used in reporting], and OPAC visible stat cats display in your public catalogue.
...
the patron account. If no is selected, it will not be. (The stat cat will also not appear if no value has been entered for the patron.)
