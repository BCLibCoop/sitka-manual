...
* *Sip Field*: If applicable, select the SIP field identifier that will contain the category and its value.
* *SIP Format*: If applicable, specify the SIP format string.
