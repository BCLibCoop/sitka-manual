...
* *OPAC Visible*: If yes is selected, the stat cat name and the selected value are displayed in the patron’s account in the OPAC. If no is selected, it will not display there.
