...
+
. Enter the Entry Value and click *Save*.
+
...
. Click the checkbox of the entry you want to edit.
. Select *Actions -> Edit Selected*.
. Change the Entry Value and click *Save*.
. Repeat as needed to edit other entries.
. Clicking *Return* in the top right of the screen will take you back to the previous Statistical Categories - Patron Editor screen.
