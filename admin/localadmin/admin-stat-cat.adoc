...
[NOTE]
======
Previously, statistical category entries could not be edited or deleted in the staff client, and Co-op Support needed to assist. Library staff can now deleted statistical category entries.
======
