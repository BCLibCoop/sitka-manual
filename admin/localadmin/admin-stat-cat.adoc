...
. Statistical categories are displayed for your workstation's library. Multi-branch libraries 
...
. Your changes will be reflected in the grid and in the statistical category field in the holdings editor.
...
all associated values are also removed from all item records. 
...
+
. The entry is updated in the grid as well as on any items using the value.
