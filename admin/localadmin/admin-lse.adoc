...
. Click *History* to view the previous values, if any, of a setting.
...
* xref:_library_settings_openapi[]
...
|Patron view discovery layer URL | URL for displaying an item in the "patron view" discovery layer with a placeholder for the bib record ID. | Text | Evergreen URL | Sitka | Set by Sitka. If you would like it changed, please submit a support ticket.
...
the cloned user which can only be edited from the cloned user record.|True/False| TRUE | LSA |
...
Only applies if _Circ: Void lost item billing_ or _Circ: Void processing fee on lost item_ 
...
|When aging circulations do not retain the patron postal code |When true, the postal code of the 
patron is not retained in circulations that have been aged to further ensure circulations are 
anonymized. | True/False |TRUE | Sitka |

|When aging circulations do not retain the year from patron date of birth |When true, the birth 
year of the patron is not retained in circulations that have been aged to further ensure 
circulations are anonymized. | True/False |TRUE | Sitka |

|When aging holds do not retain the patron postal code |When true, the postal code of the patron 
is not retained in holds that have been aged to further ensure holds are anonymized.
 | True/False |TRUE | Sitka |

|When aging holds do not retain the year from patron date of birth |When true, the birth year the 
patron is not retained in holds that have been aged to further ensure holds are anonymized. | 
True/False |TRUE | Sitka |
...
|Enable Angular Circulation Menu | | True/False | FALSE | Sitka | Angular circulation is still 
being developed and is not ready for live use yet.
...
|Format Date+Time with this pattern| |Text|yyyy-MM-dd HH:mm | Sitka |

|Format Dates with this pattern | | Text | yyyy-MM-dd | Sitka |
...
|Hide the Clear These Holds button |Hide the Clear These Holds button from 
the Holds Shelf interface.| True/False | |Sitka |This feature is not used by Sitka.

|Hide the entire template bar in Holdings Editor |Hides the template bar in the 
Volume/Copy/Holdings Editor. By default, the template bar is displayed in this interface.| 
True/False | |Sitka |This feature is not used by Sitka.
...
|Place holds for recent patrons | Loading a patron in the place holds interface designates them as
 recent. Show the interface to load recent patrons when placing holds. |True/False| | LSA |
...
validation on the default_sms_notify field in patron registration. | Regular expression | |LSA | 
This feature is not used by Sitka. 
...
|Require Photo URL field on patron registration | The Photo URL field will be required on the patron registration screen. | True/False | | Sitka | https://bc.libraries.coop/support/[Contact Co-op Support]
if you wish to use the photo URL feature.
...
|Show Photo URL field on patron registration | The Photo URL field will be shown on the patron registration screen. 
Showing a field makes it appear with required fields even when not required. If the field is required this setting is ignored. 
|True/False| FALSE | Sitka | https://bc.libraries.coop/support/[Contact Co-op Support]
if you wish to use the photo URL feature.
...
|Suggest Photo URL field on patron registration |The Photo URL field will be suggested on the patron registration screen. 
Suggesting a field makes it appear when suggested fields are shown. If the field is shown or required this setting is ignored. 
| True/False | | Sitka | https://bc.libraries.coop/support/[Contact Co-op Support]
if you wish to use the photo URL feature.
...
the current patron to renew|True/False|  | LSA |
...
|Admin organizational unit for Quipu eCard feature |Organizational unit used by the Evergreen 
admin user of the Quipu eCard feature |Selection list | | |This feature is not used by Sitka.

|Barcode length for Quipu eCard feature |Set the barcode length for new Quipu eCard 
users | | | |This feature is not used by Sitka.

|Barcode prefix for Quipu eCard feature |Set the barcode prefix for new Quipu eCard 
users | | | |This feature is not used by Sitka.

|Calculate barcode checkdigit for Quipu eCard feature |Calculate the barcode check digit for 
new Quipu eCard users |True/False | | |This feature is not used by Sitka.

|Change reshelving status interval|Amount of time to wait before changing an item from 
"Reshelving" status to "Available" | Duration| 1 day | LSA | Shortest duration is 59 minutes. Evergreen checks hourly for items that have been 
in Reshelving longer than the entered value and updates them to Available accordingly.
...
|Evergreen Admin Username for the Quipu eCard feature |Username of the Evergreen admin account
 that will create new Quipu eCard users |Text | | |This feature is not used by Sitka.
...
|Library time zone | Define the time zone in which a library physically resides.  | Text | |Sitka |
...
|Number of valid addresses needed to offer patron account e-renewal via Quipu |Number of valid 
addresses that a patron record must have in order to offer e-renewal via Quipu. Zero means 
that the patron record address are not considered; one means that either the mailing or 
billing/physical address must be set and marked as valid; two means that both the mailing and 
billing/physical address must be set and marked as valid. Default value is two 
(2). |Number | | |This feature is not used by Sitka.

|Patron permission profile after verification for Quipu eCard feature |Patron permission profile 
after verification for Quipu eCard feature. This is only used if the setting "Enable eCard 
verification feature in the OPAC" is active. |Selection list | | |This feature is not used 
by Sitka.

|Patron permission profile for Quipu eCard feature |Patron permission profile for Quipu eCard 
feature |Selection list | | |This feature is not used 
by Sitka.
...
|Quipu eCard Customer Account |Quipu Customer Account ID to be used for eCard registration |Number
| | |This feature is not used by Sitka.

|Quipu eCard/eRenew Fully Qualified Domain Name | Quipu ecard/eRenew Fully Qualified Domain 
Name is the external hostname for the Quipu server. Defaults to ecard.quipugroup.net |Text | | |This feature is not used by Sitka.

|Quipu eCard Shared Secret |Quipu Customer Account shared secret to be used for eCard 
authentication |Text | | |This feature is not used by Sitka.
...
|Enable eCard registration feature in the OPAC |Enable access to the eCard registration 
form in the OPAC |True/False | | |This feature is not used by Sitka.

|Enable eCard renewal feature in the OPAC |Enable access to the eCard renewal 
form in the OPAC |True/False | | |This feature is not used by Sitka.

|Enable eCard verification feature in the OPAC |Enable access to the eCard verification 
form in the OPAC |True/False | | |This feature is not used by Sitka.
...
|Google Analytics: Code | Account code provided by Google. (Example: G-GVGQ11X12) |Text | | | 
This feature is not used by Sitka.

|Google Analytics: Enable | Enable Google Analytics in the OPAC. Default is false. |True/False
 |FALSE| |This feature is not used by Sitka.
...
|KPAC Audience Filter |Controls which items to display based on MARC Target Audience
 (Audn) field. Options are: a,b,c,d,j. Default is: a,b,c,j |Text | |Sitka |
...
|Number of days before account expiration in which to offer an e-renewal. |Text | | | |This 
feature is not used by Sitka.

|OPAC Alert Banner: Display | Show an alert banner in the OPAC. 
Default is false. |True/False| FALSE | LSA |

|OPAC Alert Banner: Text | Text that will display in the alert banner. |Text|  | LSA |

|OPAC Alert Banner: Type | Determine the display of the banner. Options are: success, info, 
warning, danger. |Selection list|  | LSA |Sitka Support recommends using 'danger' for best visibility.
...
|Show KPAC Link | Show the KPAC link in the OPAC. Default is false. |True/False| |Sitka |
...
|Stackmap: Enable |Enable Stackmap in the OPAC. Default is false. |True/False |FALSE | |This 
feature is not used by Sitka.

|Stackmap: Identifier |
Account code provided by Stackmap. (Example: pines-evergreen) |Text | | |This feature is not used by Sitka.
...
[[_library_settings_openapi]]
.OpenAPI data access control
[options="header"]
|===
|OpenAPI data access control
|All settings are set by Sitka.
...
|Allow both Shibboleth and native Staff Client authentication |When Shibboleth SSO is enabled, 
also allow native Evergreen authentication |True/False | | |This feature is not used by Sitka.
...
|Enable Shibboleth SSO for the Staff Client| |True/False| | | This feature is not used by Sitka.

|Evergreen Staff SSO matchpoint| Evergreen-side field to match a patron against for Shibboleth 
SSO. Default is usrname. Other reasonable values would be barcode or email. |Text | | |This 
feature is not used by Sitka.

|Log out of the Staff Shibboleth IdP |When logging out of Evergreen, also force a logout of the 
IdP behind Shibboleth |True/False | | |This feature is not used by Sitka.
...
|Shibboleth Staff SSO Entity ID | |Text | | |This feature is not used by Sitka.

|Shibboleth Staff SSO matchpoint | Shibboleth-side field to match a patron against for Shibboleth 
SSO. Default is uid; use eppn for Active Directory |Text | | |This feature is not used by Sitka.

|Specific Shibboleth Application path. Default /Shibboleth.sso| |Text | | |This feature 
is not used by Sitka.

|Staff login inactivity timeout (in seconds)|Number of seconds of inactivity before 
staff client prompts for login and password.|Number|28800 |LSA |
|===
...
|GUI: Show guardian email field on patron registration | The guardian email field will be shown on 
the patron registration screen. Showing a field makes it appear with required fields even 
when not required. If the field is required this setting is ignored. | True/False |FALSE | Sitka | 
This feature is not used by Sitka.
...
|GUI: Suggest guardian email field on patron registration | The guardian email field will be 
...
ignored. | True/False |FALSE | Sitka | This feature is not used by Sitka.
