...
|Require Photo URL field on patron registration | | True/False | | Sitka | https://bc.libraries.coop/support/[Contact Co-op Support]
...
|Show Photo URL field on patron registration|True/False| FALSE | Sitka | https://bc.libraries.coop/support/[Contact Co-op Support]
if you wish to use the photo URL feature.
