...
|Patron search diacritic insensitive | Match patron last, first, and middle names irrespective of usage of diacritical marks or spaces. (e.g., Ines will match In�s; de la Cruz will match Delacruz) | True/False | Default: True |Sitka
