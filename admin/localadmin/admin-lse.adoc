...
|Show Geographic Proximity in Miles |When set to TRUE, will cause the record details page to show distances for geographic proximity in miles instead of kilometers. |True/False | | LSA| This feature is not used by Sitka.
