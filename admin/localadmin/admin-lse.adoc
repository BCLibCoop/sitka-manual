...
|When aging circulations do not retain the patron postal code | | True/False |TRUE | Sitka |

|When aging circulations do not retain the year from patron date of birth | | True/False |TRUE | 
Sitka |

|When aging holds do not retain the patron postal code | | True/False |TRUE | Sitka |

|When aging holds do not retain the year from patron date of birth | | True/False |TRUE | Sitka |
...
|KPAC Audience Filter |Controls which items to display based on MARC Target Audience
 (Audn) field. Options are: a,b,c,d,j. Default is: a,b,c,j |Text | | |
...
|Show KPAC Link | Show the KPAC link in the OPAC. Default is false. |True/False| | |This feature 
...
|Globally filtered Fieldmapper properties | |Text | | | This feature is not used by Sitka.

|Globally whitelisted Fieldmapper properties | |Text | | | This feature is not used by Sitka.
