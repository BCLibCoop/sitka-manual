...
|Allow email notify|Permit email notification when a reservation is ready for pick-up.|True/false|LSA
...
|Spine label maximum lines|Set the default maximum number of lines for spine labels.|Number| | LAS
|======================
