...
|Show Photo URL field on patron registration | The Photo URL field will be shown on the patron registration screen. Showing a field makes it appear with required fields even when not required. If the field is required this setting is ignored. |True/False| FALSE | Sitka | https://bc.libraries.coop/support/[Contact Co-op Support]
if you wish to use the photo URL feature.
...
|Suggest Photo URL field on patron registration |The Photo URL field will be suggested on the patron registration screen. Suggesting a field makes it appear when suggested fields are shown. If the field is shown or required this setting is ignored. | True/False | | Sitka | https://bc.libraries.coop/support/[Contact Co-op Support]
if you wish to use the photo URL feature.
