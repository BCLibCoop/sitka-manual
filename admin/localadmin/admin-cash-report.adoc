...
NOTE: Customized payment reports can be created from the reports interface. Several shared templates are available under Sitka_templates -> Bills_Payments folder. For instructions 
on using shared templates see xref:_shared_sitka_templates[].
