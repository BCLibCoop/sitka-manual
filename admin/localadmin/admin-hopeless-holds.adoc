...
items that could potentially fill the hold are in a hopeless prone item status.
...
.. *xref:_cancelling_holds_in_the_staff_client[Cancel Hold]* to cancel the patron's hold.
