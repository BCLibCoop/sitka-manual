...
If you do not have Hatch installed on your computer you will see this message 
"Hatch Status: Not Connected", the checkbox *Use Hatch for Printing?* will be unchecked 
and you will see the message "Printer settings below will have no effect."
