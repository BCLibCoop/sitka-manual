...
Refer to xref:_hatch_download[] for installation instructions.

[[_hatch_troubleshooting]]
...
Hatch will only work with Windows 8, 10, and 11 at this time. If you are going to submit a ticket, include the version in your ticket, as well as whether it is 32 or 64-bit. You can find this by:
...
Verify that you are running the correct version of the Hatch Chrome Extension (0.4.0).
...
. Verify that it is version 0.4.0 and Enabled.
