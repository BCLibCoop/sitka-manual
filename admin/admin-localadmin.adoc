...
| xref:cash_report[Cash Reports] |	View summary report of cash transactions for selected date range | All staff
| Circulation Policies |	View circulation policies	| Viewable to LSA. Contact Co-op Support for editing
| Closed Dates Editor	| Set library ad hoc closure dates (affects due dates and fines)	| LSA
