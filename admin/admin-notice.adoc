...
CAUTION: If libraries are setup with both 3 day email notice and 3 day SMS notice templates, patrons will receive both an email and a text. The action trigger runs early in the morning, SMS messages will be sent around *2:00am*.
