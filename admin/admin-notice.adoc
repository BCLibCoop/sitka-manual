...
+
image:images/circ/patron-notifications-1.png[]
+
...
states.
+
image:images/circ/patron-notifications-2.png[]
+
. You can re-send a completed notification by selecting it and clicking *Reset Selected Event*.
+
image:images/circ/patron-notifications-3.png[]
+
. You can cancel a pending notificiation by selecting it and clickingk *Cancel Selected Event*.
+
image:images/circ/patron-notifications-4.png[]
