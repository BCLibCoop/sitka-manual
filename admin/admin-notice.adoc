...
* Mail - sent as a PDF to the library to be mailed out 
...
in the library setting _Sending email address for patron notices_.  This ensures any patron replies are 
directed to the email of your choice. Bounced emails are also directed to this email address and we 
...
Patrons can opt out of receiving overdue and courtesy notice emails through the 
xref:_notification_preferences[Notification Preferences] in _My Account_.
