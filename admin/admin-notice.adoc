...
* Text in italics can be customized to reflect individual library's needs.
* Text in all caps indicates that the information is pulled from Evergreen and is not editable


Hold Notification Example
^^^^^^^^^^^^^^^^^^^^^^^^^

*** This is an automated message. Please do not respond. ***

Notification Date: 2013-09-22
...
_The item you requested is available for pickup from the_ YOUR LIBRARY NAME. _Contact the Circulation Desk 
to check out the item, or call_ LIBRARY PHONE NUMBER/LIBRARY EMAIL _for more information_.
...
_Your item will be held until_ HOLD SHELF EXPIRE DATE.

_If you are unable to pick up your hold , please cancel your hold so that another patron can enjoy the item.
 You can log into your account here:_  LINK TO LIBRARY MY ACCOUNT PAGE

_Thank you for using your local library._
