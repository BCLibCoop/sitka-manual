...
Co-op Support.  Local system administrators can view but not edit the action trigger templates used by their library xref:action-triggers[Action Triggers]. If you are unsure what notifications your library has set up, please contact 
