...
Acquisitions, carousel, cover art, and reporter permissions are granted as secondary permission groups. See
xref:_secondary_permission_groups[] for information on specific secondary permission groups.



Full reporter permissions are granted by Co-op Support after a 
https://bc.libraries.coop/support/sitka/reporter-privacy-waiver/[Reporter Privacy Waiver] is completed.


Acq Admin users can grant acquisitions permissions.
...
is found under Shared Folders -> Templates -> Sitka_templates -> Patrons -> Library Staff. 
