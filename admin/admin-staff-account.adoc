...
. Change the main permission group to a patron permission group (or contact Support in the case of a LSA)
. Contact Support if the staff member had permission to view report output or access to the reporter
