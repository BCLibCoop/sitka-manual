...
** Log into _My Account_ and using the the *Change* button found on the *Personal Information* tab of 
*Account Preferences*.
+
...
. Change the main permission group to a patron permission group (or contact 
https://bc.libraries.coop/support/[Co-op Support] in the case of a local system
administrator)
. Contact https://bc.libraries.coop/support/[Co-op Support] if the staff member had permission to view report output or access to the reporter
