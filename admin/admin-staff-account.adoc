...
groups is available for each library type. This list can be customized so show only the library staff 
...
See xref:_resetting_staff_account_password[] for more ways a library staff password can be reset.
...
See xref:_resetting_staff_account_password[] for ways a library staff password can be reset.

Local system administrator accounts can only be edited in the staff client by Co-op Support. If a local 
system administrator account needs edits beyond what can be done via My Account please
...
See xref:_secondary_permission_groups[] for instructions.
...
xref:_secondary_permission_groups[] for instructions.
...
[[_grant_secondary_permission_groups]]
Secondary Permission Groups
^^^^^^^^^^^^^^^^^^^^^^^^^^^

* xref:_granting_secondary_permission_group[Granting a Secondary Permission Group]
* xref:_removing_secondary_permission_group[Removing a Secondary Permission Group]
...
Granting a Secondary Permission Group
+++++++++++++++++++++++++++++++++++++
...
Removing a Secondary Permission Group
+++++++++++++++++++++++++++++++++++++
