...
Cover Image Upload and Reporter View Output permissions can be granted to and removed from 
...
xref:_secondary_permission_groups[] for information on specific secondary permission groups.

[CAUTION]
=========
The _Reporter View Output Permissions_ or _Cover Image Upload Secondary Perms groups only function as secondary 
...
of library staff at your library who have a secondary permission group assigned to their account.  This template 
is found under Shared Folders -> Templates -> Sitka_templates -> Patrons -> Library Staff. Co-op Support 
recommends running this report on an annual basis to keep track of who at your library has secondary permission
granted.
...
. Find the staff account on *User Permission Editor*. You may search for the patron account, then go to 
...
administrator)
. https://bc.libraries.coop/support/[Contact Co-op Support] if the staff member had permission to view report output or access to the reporter
