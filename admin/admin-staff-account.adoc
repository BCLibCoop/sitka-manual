...
Library staff must complete a 
https://bc.libraries.coop/support/sitka/reporter-privacy-waiver/[Full Reporter Privacy Waiver].  Once the waiver
has been received Co-op Staff will grant this 
