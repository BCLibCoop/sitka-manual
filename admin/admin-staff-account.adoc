...
** The password reset link is disabled for libraries using single sign-on.  If your library uses
single sign-on please contact 
...
** Local system administrators can assign a new password to staff that are not 
also local system administrators.
