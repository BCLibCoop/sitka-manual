...
administrator can then be copy/pasted into the Patron Deletion Tool.
...
. In the xref:_accessing_the_patron_deletion_tool[Patron Deletion Tool]l enter the barcodes for the accounts to 
be deleted (one barcode per line).
