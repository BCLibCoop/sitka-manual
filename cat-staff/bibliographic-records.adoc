...
The *Staff View* tab contains information from the MARC record presented in a human-readable format. Hyperlinks are to a relevant search. For example, if a record has an ISBN, the ISBN hyperlink is to a numeric search for this ISBN.
