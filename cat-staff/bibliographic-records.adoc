...
** *Clear Added Content Cache*: *THIS WORDING MUST BE UPDATED THANK YOU* and the popup _Added Content Cache Cleared_ appears.
** *View/Place Orders*: The _Line Items Related to Bib Record_ page in the _Acquisitions_ module opens in a new tab.

*Regarding Clear Added Content Cache*: It also does not appear here https://docs.evergreen-ils.org/docs/latest/staff_catalog/bibliographic_records.html#record_actions
