...
* *Title*: The title, which hyperlinks to the record's URL. (Clicking the title link will direct you to the record's location with no other information in the URL, which may be useful to use when sharing the link to a bibliographic record.)
...
* *Record Owner*: The Evergreen account of the record owner, hyperlinked to the account.
* *TCN*: The record's Title Control Number.
* *Database ID*: The record's database ID.
* *Created On*: The date the record was created.
* *Created By*: The Evergreen account of the record creator, hyperlinked to the account.
* *Last Edited By*: The Evergreen account of user who most recently edited the record, hyperlinked to the account.
