...
+
image::images/staffcat/configure/search-preferences-1.png[Catalogue Preference Button]
+
. Set the values you would like for your preferences.
+
image::images/staffcat/configure/search-preferences-2.png[Catalogue Preference Options]
+
...
image::images/staffcat/configure/search-preferences-3.png[Catalogue Preference Course Reserves]

When the box for _Show course materials selector_ is checked an additional filter will appear in the
Search Form. 

image::images/staffcat/configure/search-preferences-4.png[Catalogue Course Reserves Filter]
