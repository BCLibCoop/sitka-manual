...
You may also select *Basket Actions* -> *View Basket*. The basket opens.
...
To place a hold on every item in the basket, select *Basket Actions* -> *Place Hold*. The _Place Hold_ form appears. Place the hold the same way you place a hold for a single item. 

Print Title Details
~~~~~~~~~~~~~~~~~~~

To print the details of each record in the basket, select *Basket Actions* -> *Print Title Details*. A printer-friendly version of the basket will appear.
...
To export the records in the basket, select *Basket Actions* -> *Export Records*. The _MARC Batch Import/Export_ page opens.
