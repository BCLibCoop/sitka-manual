...
To add all search results, click _Basket Actions_ in the search form below the _Library Selector_. 
...
To remove all records from the basket, click the _Basket Actions_ button in the search form. Then, click _Clear Basket_. All records are removed from the basket.

Viewing the Basket
~~~~~~~~~~~~~~~~~~

To view a basket, click the basket icon in the search form, located to the left of the _Basket Actions_ button. The basket opens.
...
To add the basket to a bucket, click _Basket Actions_ -> _Add Basket to Bucket_. The _Add # Items to Bucket_ window appears. 
