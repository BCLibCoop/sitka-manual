...
To change your search library, select the text box to the left of the *Search* button and make 
...
To add an additional search row, click the _plus sign_ (+) to the right of the Search Terms text box. A new search row appears below the first. 
...
To delete a search row, click the _minus sign_ (-) to the right of the row you wish to delete.
...
The options available in each filter depend on the library selected in the xref:staff_catalog:searching_the_catalog.adoc#library_selector[Library Selector]. The available filters are: _Language_, _Audience_, _Literary Form_, and _Shelving Location_.
...
Then, enter the value for which you are searching in the _Value_ text box. Begin the search by selecting the *Search* button in the top-right corner. Search results appear below the search form.

You can only search one tag or subfield per row. To add additional rows, click the _plus sign_ (+) to the right of the search row. To remove rows, click the _minus sign_ (-) to the right of the search row.
...
The Browse pane allows you to view bibliographic headings that fall around your search term alphabetically. Each result links to catalogue records that contain the indicated bibliographic information. (To browse by call number, see xref:staff_catalog:searching_the_catalog.adoc#shelf_browse[Shelf Browse].)
...
The Shelf Browse pane allows you to browse by call number. It will return results that fall around your search term alphabetically or numerically. Each result links to catalogue records. (To browse by bibliographic headings, see xref:staff_catalog:searching_the_catalog.adoc#browse_search[Browse].)
