...
. Check the **Update Inventory** check box. SCREENSHOT REQUIRED.

. A banner will display across the top of the screen to indicate that Update Inventory is enabled. SCREENSHOT REQUIRED.
