...
to the tag. For example, to search by publisher name (e.g. Random House), enter 264 in the _Tag:_ field, b in the _Subfield:_ field, and Random House in the _Value:_ field.
+
