...
also update your search by clicking the *Update Search Results* button at top of search
results. Updating a search this way allows you to add search filters such as Publication Date, Format,
