...
007, 008, 041, or 341 fields of the MARC record. Records with incorrect coding will not filter correctly. See
xref:_search_filters_and_format_icons[] for more information.
=====
