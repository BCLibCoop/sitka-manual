...
records to include in your search results.  xref:_format_filters_and_format_icons[]
=====
...
xref:_search_methodology[Public Catalogue Order of Results]. In
...
* Search for an exact phrase using double-quotes. For example, “golden compass”.
  ...
  - To prevent xref:_search_methodology[stemming], use double quotes around a single word or a phrase. So, a search
