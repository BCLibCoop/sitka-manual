...
[NOTE]
======
Instead of linking to the library information page, the library or branch name in the _Location_ column can
link to your library's website.

To do this you must enter a value for the library setting _Library information URL (such as "http://example.com/about.html")_
and then set the library setting _Use external "library information URL" in copy table, if available_ to TRUE.
======
...
it by entering  a value for the library setting _Library information URL (such as "http://example.com/about.html")_.
...
Irregular closures of the library will display based on what has been entered in the Closed Dates Editor.
