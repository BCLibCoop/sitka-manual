...
Your patrons and staff can access information about their account from any page in the public catalogue by
...
To opt-out of receiving courtesy and overdue email notices use the _Receive
...
To receive checkout receipts via email by default check the
