...
On the reservations tab patrons can view items they have reserved, are ready for pick up, and items 
that they have checked out through the Booking Module.
