...
. Titles are added to a list by first adding them to the basket. Refer to xref:_adding_titles_to_the_basket
+
. From the basket actions menu select *View Basket* and click *Go*.
+
. Check the boxes for the titles you wish to add to your list.
+
