...
. Click *Move selected items to list* and choose the list you want from the drop down.
+
...
Information on placing holds can be found in xref:_public_catalogue_place_hold[].
